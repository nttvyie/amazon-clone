...
import { vnFlag, logo } from '../../assets/index';
        ...
        <div className="w-full bg-amazon_light text-white">
            ...
            <div className="w-full flex gap-6 items-center justify-center py-6">
                ...
                <div className="flex gap-2">
                    <p className="flex gap-1 items-center justify-center border boder-gray-500 hover:border-amazon_yellow cursor-pointer duration-200 px-2 py-1">
                        English
                    </p>
                </div>
                <div className="flex gap-1 items-center justify-center border border-gray-500 hover:border-amazon_yellow cursor-pointer duration-200 px-2 py-1">
                    <img className="w-6" src={vnFlag} alt="Flag Img" />
                    <p>Vietnam</p>
                </div>
            </div>
            {/* ========== Bottom End Hear ========== */}
